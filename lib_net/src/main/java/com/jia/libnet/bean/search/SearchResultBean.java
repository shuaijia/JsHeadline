package com.jia.libnet.bean.search;
...
public class SearchResultBean {
    ...
    public static class DataBeanX {
        ...
        private List<NewsBean.DataEntity.ImageListEntity> image_list;
...
//        }
        ...
        public List<NewsBean.DataEntity.ImageListEntity> getImage_list() {
            return image_list;
        }

        public void setImage_list(List<NewsBean.DataEntity.ImageListEntity> image_list) {
