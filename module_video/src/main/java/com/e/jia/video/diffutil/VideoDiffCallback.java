package com.e.jia.video.diffutil;
...
public class VideoDiffCallback extends DiffUtil.Callback {
    ...
    // 新老数据集
    private List<VideoArticleBean> oldList, newList;

    public VideoDiffCallback(List<VideoArticleBean> oldList, List<VideoArticleBean> newList) {
    ...
    public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
        VideoArticleBean oldData = oldList.get(oldItemPosition);
        VideoArticleBean newData = newList.get(newItemPosition);
